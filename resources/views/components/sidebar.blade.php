    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            <li class="{{ Request::is('credits') ? 'active' : '' }}">
                <a class="nav-link" href=""><i class="fa-sharp-duotone fa-solid fa-house"></i>
            ...
            @if (Auth::user()->roles == 'ADMIN')
                <li class="{{ Request::is('credits') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('user.index') }}"><i
                            class="fa-sharp-duotone fa-solid fa-users"></i>
            ...
            <li class="{{ Request::is('credits') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('product.index') }}"><i
                        class="fa-sharp-duotone fa-solid fa-store"></i>
